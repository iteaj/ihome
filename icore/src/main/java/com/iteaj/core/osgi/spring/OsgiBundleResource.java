 ...
 * Knopflefish and Felix, jettyhome.etc..) are supported. Resources outside the OSGi space
 * (<code>file:</code>, <code>http:</code>, jettyhome.etc..) are supported as well as the
